	...
	public void onDraw(Canvas canvas) {
		try {
			...
			if (resultBitmap != null) {
				...
				// 左上角
				canvas.drawRect(frame.left, frame.top, frame.left + 85,
						frame.top + 5, paint);
				canvas.drawRect(frame.left, frame.top, frame.left + 5,
						frame.top + 85, paint);
				// 右上角
				canvas.drawRect(frame.right - 85, frame.top, frame.right,
						frame.top + 5, paint);
				canvas.drawRect(frame.right - 5, frame.top, frame.right,
						frame.top +85, paint);
				// 左下角
				canvas.drawRect(frame.left, frame.bottom - 5, frame.left + 85,
						frame.bottom, paint);
				canvas.drawRect(frame.left, frame.bottom - 85, frame.left + 5,
						frame.bottom, paint);
				// 右下角
				canvas.drawRect(frame.right - 85, frame.bottom - 5,
						frame.right, frame.bottom, paint);
				canvas.drawRect(frame.right - 5, frame.bottom - 85,
						frame.right, frame.bottom, paint);
